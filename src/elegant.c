...
#  if HAVE_GPU
  ...
  char *GREETING = "This is gpu-Pelegant 2026.5Beta1 ALPHA RELEASE, "__DATE__
...
#  else
  ...
  char *GREETING = "This is elegant 2026.5Beta1 "__DATE__
...
#  if HAVE_GPU
  ...
  char *GREETING = "This is gpu-elegant 2026.5Beta1 ALPHA RELEASE, "__DATE__
    ", by M. Borland, K. Amyx, J. Calvey, M. Carla', N. Carmignani, AJ Dick, Z. Duan, M. Ehrlichman, L. Emery, W. Guo, J.R. King, N. Kuklev, R. Lindberg, I.V. Pogorelov, V. Sajaev, R. Soliday, Y.-P. Sun, M. Wallbank, C.-X. Wang, Y. Wang, Y. Wu, and A. Xiao.";
#  else
