...
ELEMENT_DESCRIPTION entity_description[N_TYPES] = {
  ...
  {N_TFBPICKUP_PARAMS, MPALGORITHM | NO_APERTURE | COLLECTIVE_EFFECTS, sizeof(TFBPICKUP), tfbpickup_param},
  {N_TFBDRIVER_PARAMS, MPALGORITHM | RUN_ZERO_PARTICLES | COLLECTIVE_EFFECTS, sizeof(TFBDRIVER), tfbdriver_param},
