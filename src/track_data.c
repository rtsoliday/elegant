...
ELEMENT_DESCRIPTION entity_description[N_TYPES] = {
  ...
  {N_NIBEND_PARAMS, MAT_LEN_NCAT | IS_MAGNET | GPU_SUPPORT,
   sizeof(NIBEND), nibend_param},
  {N_KPOLY_PARAMS, 0, sizeof(KPOLY), kpoly_param},
  {N_NISEPT_PARAMS, MAT_LEN_NCAT | IS_MAGNET | GPU_SUPPORT,
  ...
  {N_RFMODE_PARAMS, MPALGORITHM | HAS_MPI_COLLECTIVE | GPU_SUPPORT, sizeof(RFMODE), rfmode_param},
  {N_TRFMODE_PARAMS, MPALGORITHM | HAS_MPI_COLLECTIVE | GPU_SUPPORT, sizeof(TRFMODE), trfmode_param},
  {N_ZLONGIT_PARAMS, HAS_MPI_COLLECTIVE, sizeof(ZLONGIT), zlongit_param},
  ...
  {N_BMAPXY_PARAMS, MAT_LEN_NCAT | IS_MAGNET | GPU_SUPPORT, sizeof(BMAPXY), bmapxy_param},
  {N_ZTRANSVERSE_PARAMS, HAS_MPI_COLLECTIVE, sizeof(ZTRANSVERSE), ztransverse_param},
  {N_IBSCATTER_PARAMS, MPALGORITHM | HAS_MPI_COLLECTIVE, sizeof(IBSCATTER), ibscatter_param},
  {N_FMULT_PARAMS, MAT_LEN_NCAT | IS_MAGNET | SPIN_TRACKING, sizeof(FMULT), fmult_param},
  {N_WAKE_PARAMS, MAY_CHANGE_ENERGY | BACKTRACK | MPALGORITHM | GPU_SUPPORT | HAS_MPI_COLLECTIVE, sizeof(WAKE), wake_param},
  {N_TRWAKE_PARAMS, 0 | BACKTRACK | MPALGORITHM | GPU_SUPPORT | HAS_MPI_COLLECTIVE, sizeof(TRWAKE), trwake_param},
  ...
  {N_CSRCSBEND_PARAMS, MAT_LEN_NCAT | IS_MAGNET | MPALGORITHM | GPU_SUPPORT | BACKTRACK | HAS_MPI_COLLECTIVE,
   sizeof(CSRCSBEND), csrcsbend_param},
  {N_CSRDRIFT_PARAMS, MAT_LEN_NCAT | MPALGORITHM | DIVIDE_OK | GPU_SUPPORT | HAS_MPI_COLLECTIVE,
  ...
  {N_SCRIPT_PARAMS, MAT_LEN | DONT_CONCAT | MPALGORITHM | BACKTRACK | HAS_MPI_COLLECTIVE, sizeof(SCRIPT), script_param},
  ...
  {N_FRFMODE_PARAMS, MPALGORITHM | HAS_MPI_COLLECTIVE | GPU_SUPPORT, sizeof(FRFMODE), frfmode_param},
  {N_FTRFMODE_PARAMS, MPALGORITHM | HAS_MPI_COLLECTIVE | GPU_SUPPORT, sizeof(FTRFMODE), ftrfmode_param},
  {N_TFBPICKUP_PARAMS, MPALGORITHM | NO_APERTURE | HAS_MPI_COLLECTIVE | GPU_SUPPORT, sizeof(TFBPICKUP), tfbpickup_param},
  {N_TFBDRIVER_PARAMS, MPALGORITHM | RUN_ZERO_PARTICLES | HAS_MPI_COLLECTIVE | GPU_SUPPORT, sizeof(TFBDRIVER), tfbdriver_param},
  {N_LSCDRIFT_PARAMS, MAT_LEN_NCAT | MPALGORITHM | GPU_SUPPORT | BACKTRACK | HAS_MPI_COLLECTIVE, sizeof(LSCDRIFT), lscdrift_param},
  ...
  {N_CORGPIPE_PARAMS, MAY_CHANGE_ENERGY | MPALGORITHM | MAT_LEN_NCAT | HAS_MPI_COLLECTIVE, sizeof(CORGPIPE), corgpipe_param},
  {N_LRWAKE_PARAMS, MPALGORITHM | HAS_MPI_COLLECTIVE, sizeof(LRWAKE), lrwake_param},
  {N_EHCOR_PARAMS, MAT_LEN_NCAT | IS_MAGNET | BACKTRACK | SPIN_TRACKING | GPU_SUPPORT, sizeof(EHCOR), ehcor_param},
  {N_EVCOR_PARAMS, MAT_LEN_NCAT | IS_MAGNET | BACKTRACK | SPIN_TRACKING | GPU_SUPPORT, sizeof(EVCOR), evcor_param},
  {N_EHVCOR_PARAMS, MAT_LEN_NCAT | IS_MAGNET | BACKTRACK | SPIN_TRACKING | GPU_SUPPORT, sizeof(EHVCOR), ehvcor_param},
  ...
  {N_IONEFFECTS_PARAMS, MPALGORITHM | HAS_MPI_COLLECTIVE, sizeof(IONEFFECTS), ionEffects_param},
  {N_SLICE_POINT_PARAMS, MPALGORITHM | RUN_ZERO_PARTICLES | NO_APERTURE, sizeof(SLICE_POINT), slice_point_param},
  {N_SPEEDBUMP_PARAMS, MAT_LEN_NCAT | GPU_SUPPORT, sizeof(SPEEDBUMP), speedbump_param},
  ...
  {N_TAPERAPC_PARAMS, MAT_LEN_NCAT | GPU_SUPPORT, sizeof(TAPERAPC), taperapc_param},
  {N_TAPERAPE_PARAMS, MAT_LEN_NCAT, sizeof(TAPERAPE), taperape_param},
  {N_TAPERAPR_PARAMS, MAT_LEN_NCAT | GPU_SUPPORT, sizeof(TAPERAPR), taperapr_param},
  ...
  {N_LGBEND_PARAMS, MAT_LEN_NCAT | SPIN_TRACKING | GPU_SUPPORT, sizeof(LGBEND), lgbend_param},
  {N_CORGPLATES_PARAMS, MAY_CHANGE_ENERGY | MPALGORITHM | MAT_LEN_NCAT | HAS_MPI_COLLECTIVE, sizeof(CORGPLATES), corgplates_param},
  ...
  {N_POLAR_PARAMS, DONT_CONCAT | SPIN_TRACKING | MPALGORITHM | HAS_MPI_COLLECTIVE, sizeof(POLAR), polar_param},
  {N_IMPEDANCE_PARAMS, HAS_MPI_COLLECTIVE | GPU_SUPPORT, sizeof(IMPEDANCE), impedance_param},
  {N_CWAKE_PARAMS, MAY_CHANGE_ENERGY | BACKTRACK | MPALGORITHM | HAS_MPI_COLLECTIVE | GPU_SUPPORT, sizeof(CWAKE), cwake_param},
  {N_CBSCAT_PARAMS, HAS_MPI_COLLECTIVE, sizeof(CBSCAT), cbscat_param},
};
