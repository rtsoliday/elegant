...
ELEMENT_DESCRIPTION entity_description[N_TYPES] = {
  ...
  {N_IMPEDANCE_PARAMS, COLLECTIVE_EFFECTS, sizeof(IMPEDANCE), impedance_param},
  {N_CWAKE_PARAMS, MAY_CHANGE_ENERGY | BACKTRACK | MPALGORITHM | COLLECTIVE_EFFECTS, sizeof(CWAKE), cwake_param},
};
