...
ELEMENT_DESCRIPTION entity_description[N_TYPES] = {
  ...
  {N_TRFMODE_PARAMS, MPALGORITHM | COLLECTIVE_EFFECTS, sizeof(TRFMODE), trfmode_param},
  ...
  {N_FTRFMODE_PARAMS, MPALGORITHM | COLLECTIVE_EFFECTS, sizeof(FTRFMODE), ftrfmode_param},
