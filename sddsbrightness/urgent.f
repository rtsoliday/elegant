     ...
     $     DALPHA_I,NOMEGA_I,DOMEGA_I, GET_NEE,
...
C output arrays
        DIMENSION EE_O(50001),LAMDA_O(50001),XPMM_O(251001)
        DIMENSION YPMM_O(251001),RRAD_O(251001),POWER_O(251001)
        DIMENSION L1_O(251001),L2_O(251001),L3_O(251001),L4_O(251001)
        DIMENSION EI_O(50001),SPEC1_O(50001),SPEC2_O(50001),SPEC3_O(50001)
        DIMENSION I1_O(50001),I2_O(50001),IHARM_O(50001)
        DIMENSION X5_O(750000),Y5_O(750000),E5_O(750000),
     $       POW5_O(75000),FLUX5_O(750000)
        INTEGER CODE
C        character*78    infile,outfile
     ...
     $       FV,GSIGUV,NSIG
        ...
        COMMON/CONVL/H(50001),WMIN,DW,NW
        COMMON/CALC/BRI1(501,501),BRI2(501,501),BRI3(501,501),
     $  BRI0(501,501),RAD1(501,501),RAD2(501,501),RAD3(501,501),
     $  RAD0(501,501),I1(50001),I2(50001),
     $  SPEC1(50001),SPEC2(50001),SPEC3(50001),SPEC0(50001),WK(50001)
        COMMON/OUT1/NEE,MIN_I,MAX_I,II1(251001),II2(251001),
     $       II(251001),IMAX,IHARM5
        COMMON/OUT2/EE(50001),L_LAMDA(50001),RADMAX,
     $       X_P(251001),Y_P(251001),EI1(50001),
     $       POWER1(251001),RRAD(251001),PDTOT,PTOT1,FTOT,
     $       LL1(251001),LL2(251001),LL3(251001),LL4(251001)
...
C
        ...
        IF(NE.LT.1.OR.NE.GT.50001)GOTO 900
...
C       -----------------------
     ...
     $       NALPHA,ISG(400),CODE(400)
        ...
        COMMON/SCALE/EMIN,DE,NE,NE1,NE2
        COMMON/CONVL/H(50001),WMIN,DW,NW
        COMMON/CALC/BRI1(0:500,0:500),BRI2(0:500,0:500),BRI3(501,501),
     $  BRI0(501,501),FLUXD(501,501),PD(501,501),RAD3(501,501),
     $  RAD0(501,501),I1(50001),I2(50001),
     $  SPEC1(50001),SPEC2(50001),SPEC3(50001),SPEC0(50001),WK(50001)
        COMMON/OUT1/NEE,MIN_I,MAX_I,II1(251001),II2(251001),
     $       II(251001),IMAX,IHARM5
...
C       -------------------------------------
        ...
        COMMON/UND/K3,KX,KY,LAMDAR,LEN,PHASE,N,ITYPE
        COMMON/BEAM/GAMMA,CUR,SIGX2,SIGY2,SIGU,SIGV,FU,FV,GSIGUV,NSIG
        COMMON/CALC/BRI1(0:500,0:500),BRI2(0:500,0:500),BRI3(0:500,0:500),
     $  BRI0(0:500,0:500),RAD1(501,501),RAD2(501,501),RAD3(501,501),
     $  RAD0(501,501),I1(50001),I2(50001),
     $  SPEC1(50001),SPEC2(50001),SPEC3(50001),SPEC0(50001),WK(50001)
C
